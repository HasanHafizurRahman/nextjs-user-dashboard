...
const customers = () => {
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="p-4">
        <div className="bg-white w-full p-4 border rounded-lg overflow-y-auto">
          <div className="grid md:grid-cols-4 sm:grid-cols-3 grid-cols-2 cursor-pointer justify-between items-center p-2 my-3">
            <span>Name</span>
